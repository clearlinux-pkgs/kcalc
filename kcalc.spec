...
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/kcalc-21.12.0.tar.xz
...
%prep
%setup -q -n kcalc-21.12.0
cd %{_builddir}/kcalc-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639631234
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kcalc-21.12.0/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/kcalc/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/kcalc-21.12.0/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/kcalc/f1946dab78e58c04c8c25ec6b074f5fc5c2830fe
cp %{_builddir}/kcalc-21.12.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kcalc/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/kcalc-21.12.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kcalc/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
%find_lang kcalc

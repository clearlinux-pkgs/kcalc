...
Source0  : https://download.kde.org/stable/applications/19.08.3/src/kcalc-19.08.3.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.3/src/kcalc-19.08.3.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573164324
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kcalc-19.08.3/COPYING %{buildroot}/usr/share/package-licenses/kcalc/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/kcalc-19.08.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/kcalc/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
%find_lang kcalc

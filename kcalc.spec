...
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/kcalc-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/kcalc-24.02.2.tar.xz.sig
...
%setup -q -n kcalc-24.02.2
cd %{_builddir}/kcalc-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712933704
mkdir -p clr-build
pushd clr-build
